<?php
/*
 * Ueberprüft die registrierte Benutzer-E-Mail, der Link zu dieser Seite
...
if (isset($_GET['email']) && ! empty($_GET['email'])) {
    ...
    if ($result->num_rows == 0) {
        $_SESSION['message'] = "Sie haben ihr Konto bereits aktiviert oder die URL ist ung�ltig!";
    ...
    $_SESSION['message'] = "Ung&uuml;ltige Parameter f�r die Konto&uuml;berpr&uuml;fung!";
    header("location: error.php");
}
?>